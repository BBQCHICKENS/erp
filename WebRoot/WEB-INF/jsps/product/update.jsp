...
<div class="content-right">
	...
	<div class="content-text">
		<div class="square-order">
			<form  action="${path }/ajax_product_update" method="post">
  			...
  			<div style="border:1px solid #cecece;">
				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="32%">
							<s:select list="#suppliers" id="supplierId" name="product.productType.supplier.supplierId" cssStyle="width:190px"  listKey="supplierId" listValue="name"></s:select>
				      </td>
