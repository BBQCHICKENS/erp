...
<div class="content-right">
	...
	<div class="content-text">
		<div class="square-order">
			<form action="${path }/ajax_productType_update" method="post">
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="82%" colspan="3">
						    <%--<s:select list="#dList" cssClass="kuan" name="emp.dep.depId"  listKey="depId" listValue="name"></s:select>--%>
				      		<s:select list="#suppliers" name="productType.supplier.supplierId"  cssClass="kuan"  listKey="supplierId" listValue="name"></s:select>
				      </td>
				    </tr>
				    <tr  bgcolor="#FFFFFF">
				      <td colspan="4">&nbsp;</td>
