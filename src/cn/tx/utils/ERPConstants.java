...
public interface ERPConstants {
	 ...
	 * 提货方式
	 */
	public  static final  String SUPPLIER_PICK_TYPE_MY ="1";
	public static final String SUPPLIER_PICK_TYPE_MY_TEXT = "自取";
	public  static final  String SUPPLIER_PICK_TYPE_YOU ="2";
	public static final String SUPPLIER_PICK_TYPE_YOU_TEXT = "送货";
